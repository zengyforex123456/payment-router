...
<link rel="stylesheet" href="/build/css/design-tokens.css?v=1784386560">
<link rel="stylesheet" href="/build/css/tailwind.min.css?v=1784386560">
<link rel="stylesheet" href="/build/css/container-queries.css?v=1784386560">
<link rel="stylesheet" href="/build/css/missing-utilities.css?v=1784386560">
</head><body class="bg-surface-base text-content-primary font-sans antialiased">
<header class="sticky top-0 bg-surface-raised/80 backdrop-blur-sm border-b py-3 px-6 mb-8">
<nav class="max-w-6xl mx-auto flex items-center justify-between text-sm">
...
<main class="max-w-6xl mx-auto px-6">{$content}</main>
